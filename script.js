...
(function (arrOfTasks) {
  ...
  const theme = {
    default: {
      ...
      "--default-btn-hover-bg": "blue",
      "--default-btn-border-color": "blue",
      "--danger-btn-bg": "red",
      "--danger-btn-text-color": "white",
      "--danger-btn-hover-bg": "red",
  ...
  function renderAllTasks(tasksList) {
    if (!tasksList) {
      console.error("Отсутствует список задач");
      return;
    }
  ...
  function setTheme(name) {
    const selectedThemeObj = theme[name];
